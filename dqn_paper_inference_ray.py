...
from dqn.dqn_paper import DQNExperimentBasic
import csv
...
# RUN FUNCTION
# python3 ./dqn_paper_inference_ray.py dqn/dqn_config_paper.yaml
...
if __name__ == "__main__":
    ...
    if run_all and run != 2:
        ...
        print(f'python3 ./dqn_paper_inference_ray.py dqn/dqn_config_paper.yaml "{checkpoint}" "training" "mediumRoundabout4"')
        print(f'python3 ./dqn_paper_inference_ray.py dqn/dqn_config_paper.yaml "{checkpoint}" "training" "doubleRoundabout37"')
        print(f'python3 ./dqn_paper_inference_ray.py dqn/dqn_config_paper.yaml "{checkpoint}" "testing" "20m"')
        print(f'AFTERAFTERAFTER')
        print(f'python3 ./dqn_paper_inference_ray.py dqn/dqn_config_paper.yaml "{checkpoint}" "testing" "mediumRoundabout4"')
        print(f'AFTERAFTERAFTER')
