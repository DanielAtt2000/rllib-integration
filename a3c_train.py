...
from a3c.a3c_experiment_basic import A3CExperimentBasic
from a3c.a3c_callbacks import A3CCallbacks
from a3c.a3c_trainer import CustomA3CTrainer

# Set the experiment to EXPERIMENT_CLASS so that it is passed to the configuration
EXPERIMENT_CLASS = A3CExperimentBasic
...
def run(args):
    try:
        ...
        analysis = tune.run(CustomA3CTrainer,
                 name=args.name,
